        ...
        <div class="span12">
            ...
            <form id="receiverForm" method="post">
                <div id="receiver" class="receiver">
                    ...
                    <ul class="clearfix" [#if !receivers?has_content] style="height: auto;" [/#if]>
                        [#if receivers?has_content]
                            [#list receivers as receiver]
                                <li  class="[#if receiver.isDefault]selected[/#if]" receiverId="${receiver.id}">
                                    [#if receiver.isDefault]
                                        [#assign  receiverId=receiver.id /]
                                    [/#if]
                                                <span>
                    ...
                    <div>
                        [#if receivers?exists&&receivers?size>5]
                            <a href="javascript:;" id="otherReceiverButton" class="button">更多</a>
                        [/#if]
                    ...
                    [#if cartItems?has_content]
                        [#list cartItems as cartItem]
                            <tr>
                                ...
                                [#if cartItem.productInfo.specificationValues?has_content]
                                ...
                                <td>
                                    ￥${cartItem.quantity*cartItem.productInfo.price}
                                    [#assign totalPoints=totalPoints+(cartItem.quantity*cartItem.productInfo.rewardPoint) /]
                                    [#assign totalPrice=totalPrice+(cartItem.quantity*cartItem.productInfo.price)]
                                </td>
                            </tr>
                        [/#list]
                    [/#if]
        ...
        <div class="row">
            ...
            <div class="span6">
                <ul class="statistic">
                    ...
                    <li>
							<span>
								订单金额: <strong id="amount">￥${totalPrice}元</strong>
							</span>
                    </li>
                </ul>
            </div>
