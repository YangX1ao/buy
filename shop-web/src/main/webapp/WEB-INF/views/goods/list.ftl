    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $addFavorite.click(function() {
                ...
                $.ajax({
                    url: "${ctx}/shopxx/member/favorite/add.jhtml",
                    type: "POST",
    ...
    <div class="row">
        ...
        <div class="span10">
            ...
            <form id="goodsForm" action="${ctx}/goods/list/${productCategory.id}" method="get">
                        ...
                        [#if productChildrenCategories?has_content]
                            <dl class="clearfix">
                                ...
                                [#list productChildrenCategories as productCategory]
                                    <dd><a href="${ctx}/goods/list/${productCategory.id}">${productCategory.name}</a>
                                    </dd>
                                [/#list]
                ...
                [#if resultList.pageInfo.isFirstPage()]
                ...
                [#if resultList.pageInfo.isLastPage()]
                    <span class="lastPage">&nbsp;</span>
                [#else ]
                    <a href="javascript: $.pageSkip(${resultList.pageInfo.lastPage});" class="lastPage">&nbsp;</a>
                [/#if]
